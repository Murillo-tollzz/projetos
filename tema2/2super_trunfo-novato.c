// foco do desafio: condições de vitória com base no Super Poder
...
int main() {
    ...
    // condições de vitória individuais para cada atributo
    // printf("Comparação: \n");
    ...
    // condições de vitória com base no Super Poder
